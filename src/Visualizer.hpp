...
//     Visualization"); window.setFramerateLimit(60);
...
//       std::cout << "Vertex " << vertex << " positioned at (" << x << ", " <<
//       y
//                 << ")" << std::endl;
...
//     int color_index = 0;
//     for (const auto &[vertex, _] : _adj_list) {
//       vertex_colors[vertex] = color_palette[color_index %
//       color_palette.size()]; color_index++;
//     }
...
//           float length =
//               std::sqrt(direction.x * direction.x + direction.y *
//               direction.y);
...
//                 point, sf::Color(100, 100, 100, 180)}); // Semi-transparent
//                 gray
//           }
//           window.draw(curve);
...
//           //   arrow[0].color = arrow[1].color = arrow[2].color =
//           sf::Color(100,
...
//                            text_bounds.position.y + text_bounds.size.y
//                            / 2.f});

//           weight_text.setPosition(mid_point);

//           sf::RectangleShape text_bg(
//               sf::Vector2f(text_bounds.size.x + 8.f, text_bounds.size.y
//               + 4.f));
//           // sf::RectangleShape text_bg(sf::Vector2f(text_bounds.size.x
//           + 8.f,
