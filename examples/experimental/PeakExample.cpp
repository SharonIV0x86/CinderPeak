...
int main() {
  GraphCreationOptions options({GraphCreationOptions::Directed, GraphCreationOptions::SelfLoops});
  GraphInternalMetadata metadata("cinder_graph", Traits::isTypePrimitive<int>(), Traits::isTypePrimitive<int>(),
                                 Traits::isGraphWeighted<int>(), !Traits::isGraphWeighted<int>());
