...
int main() {
    try {
        ...
        cout << "Added edge (1,2) with weight 5.5: " << (added1 ? "success" : "failed") << endl;

        auto [edge2, added2] = g1.addEdge(2, 3, 10.75);
        cout << "Added edge (2,3) with weight 10.75: " << (added2 ? "success" : "failed") << endl;
        ...
        cout << "Adding edge (10,99) where 99 doesn't exist: " << (added3 ? "success" : "failed") << endl;

        auto [edge4, added4] = g2.addEdge(100, 200, 2.71f);
        cout << "Adding edge (100,200) where neither exists: " << (added4 ? "success" : "failed") << endl;
        ...
        g4.addVertex("Y");
        g4.addEdge("X", "Y", 50);
        cout << "Added undirected edge X-Y (creates edge in both directions)" << endl;

        // 4. Parallel edges configuration
        cout << "\n--- Scenario 4: Parallel Edges ---" << endl;
        GraphCreationOptions parallelOpts({GraphCreationOptions::Directed,
        ...
        cout << "Added edge (5,6) using addEdge: " << (a5 ? "success" : "failed") << endl;
