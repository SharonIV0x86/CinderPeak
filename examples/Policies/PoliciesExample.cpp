...
int main() {
  ...
  // 1) Throw + LogConsole
  {
    ...
    PolicyConfiguration cfg(PolicyConfiguration::Throw, PolicyConfiguration::LogConsole, "");
  ...
  // 2) Throw + Silent
  {
    ...
    PolicyConfiguration cfg(PolicyConfiguration::Throw, PolicyConfiguration::Silent, "");
    PolicyHandler handler(cfg);
  ...
  // 3) Throw + LogFile
  {
    ...
    PolicyConfiguration cfg(PolicyConfiguration::Throw, PolicyConfiguration::LogFile, logfile);
    PolicyHandler handler(cfg);
  ...
  // 4) Throw + ConsoleAndFile
  {
    ...
    PolicyConfiguration cfg(PolicyConfiguration::Throw, PolicyConfiguration::ConsoleAndFile, logfile);
    PolicyHandler handler(cfg);
  ...
  // 7) Ignore + LogFile
  {
    ...
    PolicyConfiguration cfg(PolicyConfiguration::Ignore, PolicyConfiguration::LogFile, logfile);
    PolicyHandler handler(cfg);
  ...
  // 8) Ignore + ConsoleAndFile
  {
    ...
    PolicyConfiguration cfg(PolicyConfiguration::Ignore, PolicyConfiguration::ConsoleAndFile, logfile);
    PolicyHandler handler(cfg);
