...
TEST(DbgTest, Bool_True) {
    EXPECT_EQ(dbg(true), "true");
}

TEST(DbgTest, Bool_False) {
    EXPECT_EQ(dbg(false), "false");
}
...
TEST(DbgTest, Unweighted) {
    EXPECT_EQ(dbg(Unweighted{}), "Unweighted");
}
